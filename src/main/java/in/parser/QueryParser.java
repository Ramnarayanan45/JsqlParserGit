...
public class QueryParser {
    ...
    public String getChoice() {
        String choice = Input.getLine("Select \n1 -> Write Query\n2 -> Get List\n3 -> exit");
        return choice;
    }

    public int getParts() {
        int choice = Input.getChoice("Select \n0 -> All List\n1 -> Tables\n2 -> Joins\n3 -> Columns\n4 -> Conditions\n5 -> Functions\n6 -> FunctionColumns" +
                "\n7 -> GroupBy Columns\n8 -> GroupBy Criteria\n9 -> OrderBy Columns\n10 -> Sub Tables\n11 -> Sub Joins\n12 -> Sub Columns" +
    ...
    public String getInput() {
        String query = Input.getLine("Enter the Select Query");
        return query;
    }

    public Statement getStatement(String query) {
        try {
            Statement smt = CCJSqlParserUtil.parse(query);
            return smt;
        }
